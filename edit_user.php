     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          Modifier le Compte de <?php echo remove_junk(ucwords($e_user['name'])); ?> 
        </strong>
       </div>
            ...
            <div class="form-group">
              <label for="status">Statut</label>
                <select class="form-control" name="status">
                  ...
                  <option <?php if($e_user['status'] === '0') echo 'selected="selected"';?> value="0">Désactiver</option>
                </select>
            </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          Change le mdp de <?php echo remove_junk(ucwords($e_user['name'])); ?> 
        </strong>
      </div>
      <div class="panel-body">
